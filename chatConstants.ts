...
5. If the user's question cannot be answered by the provided data, state that the information is not available in the provided dataset.
6. Be helpful and conversational, but always ground your answers STRICTLY in the data provided in this turn.`;
